        ...
        <div>
          ...
          {editCard ? (
            <div>
              ...
              ></input>
              {numberError && (
                <small>Invalid Card Number: Must have 16 digits</small>
              )}
              <input
                type="text"
              ...
              ></input>
              {expError && (
                <small>Invalid Expiration: ex. month/year: **/****</small>
              )}
              <input
                type="text"
                onChange={changeExp}
              ...
              {billingError && (
                <small>Invalid Billing Address: No special characters</small>
              )}
              <input
                type="text"
          ...
          {cards.map((number) => (
            <Card key={number} number={number} cookie={cookie} />
          ))}
        </div>
      ) : (
        <p>Loading...</p>
