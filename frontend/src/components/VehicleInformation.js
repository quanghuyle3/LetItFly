        ...
        <div>
          ...
          {editCar ? (
            <div>
              ...
              ></input>
              {makeError && (
                <small>Invalid: No Special Characters. Only Letters</small>
              )}
              <input
                type="text"
                onChange={changeMake}
              ...
              ></input>
              {typeError && (
                <small>Invalid: Letters Only. No Special Characters</small>
              )}
              <input
                type="text"
                onChange={changeType}
          ...
          {vehics.map((number) => (
            <Vehicle key={number} number={number} cookie={cookie} />
          ))}
        </div>
      ) : (
        <p>Loading...</p>
